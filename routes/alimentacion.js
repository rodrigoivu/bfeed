...
api.get    ('/alimentacion-todos-dia'    , [ md_auth.ensureAuth, md_auth.ensureAdminUser ], AlimentacionController.itemsTodosDia     );
api.get    ('/alimentacion-item-dia'     , [ md_auth.ensureAuth, md_auth.ensureAdminUser ], AlimentacionController.itemDia           );
